    ...
    <?php
        ...
        echo "<form action=\"http://localhost/Spryker/Assignments/Assignment%201/update.php?e_id={$GLOBALS['e_id']}\" method=\"post\" class=\"mx-5 px-5\" enctype=\"multipart/form-data\">";
    ?>
    <div class="mb-3">
